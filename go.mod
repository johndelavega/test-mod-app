...
require (
	github.com/johndelavega/go-lib v0.0.1
	github.com/johndelavega/gomod v0.0.13
	github.com/johndelavega/test-mod-app/replacemod v0.0.0-20190222010842-aed14dd634ea
)
